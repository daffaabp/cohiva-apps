<div class="row padding-1 p-1">
    <div class="col-md-6">
        ...
        <div class="form-group mb-2 mb20">
            <label for="nama_pasien" class="form-label">{{ __('Nama Lengkap Pasien') }} <span
        ...
        <div class="form-group mb-2 mb20">
            <label for="alamat_pasien" class="form-label">{{ __('Alamat Pasien') }} <span
                    class="text-danger">*</span></label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="notelpon_pasien" class="form-label">{{ __('Notelpon Pasien') }} <span
                    class="text-danger">*</span></label>
    ...
    <div class="col-md-6">
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Jenis Kelamin') }} <span
                    class="text-danger">*</span></label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Berat Badan (kg)') }} <span class="text-danger">*</span></label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Tinggi Badan (cm)') }} <span
                    class="text-danger">*</span></label>
    ...
    <div class="col-md-12 mt20 mt-2">
        @canany(['pasiens.store', 'pasiens.create'])
