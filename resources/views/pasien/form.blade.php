<div class="row padding-1 p-1">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Usia') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Berat Badan') }}</label>
        ...
        <div class="form-group mb-2 mb20">
            <label for="id_user" class="form-label">{{ __('Tinggi Badan') }}</label>
