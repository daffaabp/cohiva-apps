<div class="row padding-1 p-1">
    <div class="col-md-4">
        ...
        <div class="mb-3">
            <label for="formFile" class="form-label">Foto Konselor</label>
            <input class="form-control" name="foto_konselor" type="file" id="formFile">
        </div>
    </div>
    <div class="col-md-8">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <div class="form-check">
                <input class="form-check-input" value="1" type="radio" name="is_aktif" id="flexRadioDefault1" checked>
                <label class="form-check-label" for="flexRadioDefault1">
                    Aktif
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" value="0" type="radio" name="is_aktif" id="flexRadioDefault2">
