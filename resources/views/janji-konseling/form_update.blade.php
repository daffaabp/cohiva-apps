    ...
    <div class="col-md-6">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <div class="form-check mb-2">
                <input class="form-check-input" value="DIJADWALKAN" {{ $janjiKonseling->status_janji == 'DIJADWALKAN' ? 'checked' : '' }}
                    type="radio" name="status_janji" id="flexRadioDefault1">
                <label class="form-check-label" for="flexRadioDefault1">
                    DIJADWALKAN
                </label>
            </div>
            <div class="form-check mb-2">
                <input class="form-check-input" value="TERLAKSANA" {{ $janjiKonseling->status_janji == 'TERLAKSANA' ? 'checked' : '' }}
                    type="radio" name="status_janji" id="flexRadioDefault2">
                <label class="form-check-label" for="flexRadioDefault2">
                    TERLAKSANA
                </label>
            </div>
            <div class="form-check mb-2">
                <input class="form-check-input" value="DIBATALKAN" {{ $janjiKonseling->status_janji == 'DIBATALKAN' ? 'checked' : '' }}
                    type="radio" name="status_janji" id="flexRadioDefault3">
