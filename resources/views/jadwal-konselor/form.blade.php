<div class="row padding-1 p-1">
    @if ($message = Session::get('error'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <p>{{ $message }}.</p><a href="{{ route('jadwal-konselors.show', encrypt(Session::get('id'))) }}" class="text-danger"><strong class="ms-1">lihat</strong></a>
    ...
    <div class="col-md-12">
        <div class="form-group mb-2 mb20">
            ...
            <select name="id_konselor" id="id_konselor" class="form-select" @readonly(true)>
                <option value="{{ $jadwalKonselor->id_konselor }}">{{ $jadwalKonselor->konselor->nama_konselor }}</option>
            </select>
            @else
            <select name="id_konselor"
                class="form-select js-example-basic-single @error('id_konselor') is-invalid @enderror" id="id_konselor">
