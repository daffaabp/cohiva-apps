...
--
-- Host: localhost:3306
-- Generation Time: May 27, 2024 at 11:30 AM
...
(13, 13073, 'Selasa', '10:00:00', '1', '2024-05-20 02:18:40', '2024-05-20 02:18:40'),
(14, 504939, 'Jumat', '10:00:00', '1', '2024-05-20 02:35:44', '2024-05-20 02:35:44');
...
INSERT INTO `janji_konseling` (`id`, `id_jadwalkonselor`, `id_konselor`, `nama_konselor`, `hari`, `jam`, `id_pasien`, `status_janji`, `created_at`, `updated_at`, `tgl_janji_konseling`) VALUES
(37, 14, 504939, 'dr. Anggreani Syafitri', 'Jumat', '10:00:00', 11, 'TERLAKSANA', '2024-05-26 13:43:24', '2024-05-26 13:43:55', '2024-05-31'),
(38, 14, 504939, 'dr. Anggreani Syafitri', 'Jumat', '10:00:00', 11, 'DIJADWALKAN', '2024-05-26 13:47:51', '2024-05-26 13:47:51', '2024-06-07');
...
CREATE TABLE `konseling` (
  ...
  `id_pasien` int(11) NOT NULL,
  `id_konselor` int(11) NOT NULL,
  `id_janjikonseling` bigint(20) NOT NULL,
...
INSERT INTO `konseling` (`id_konseling`, `tgl_konseling`, `id_pasien`, `id_konselor`, `id_janjikonseling`, `keterangan`, `status_pasien`, `keluhan`, `penilaian`, `jenis_konseling`, `status_konseling`) VALUES
(18, '2024-05-31', 11, 504939, 37, 'Molestiae omnis itaq', 'Dalam Perawatan', 'Consequatur Do ad p', 'Velit est sequi cumq', 'Tertutup', 'Membutuhkan Tindak Lanjut');
...
(504939, 'dr. Anggreani Syafitri', '081225001283', 'Universiras Al Irsyad Cilacap', NULL, 1, 71),
(553989, 'dr. Yuliana Lestari', NULL, 'Universitas Al Irsyad Cilacap', NULL, 1, 73);
...
(16, '2024_05_19_053916_create_table_email_create_token', 13);
...
(62, 'App\\Models\\User', 43),
(62, 'App\\Models\\User', 44),
(62, 'App\\Models\\User', 69),
(62, 'App\\Models\\User', 70),
(62, 'App\\Models\\User', 71),
...
(72, 'App\\Models\\User', 67),
(73, 'App\\Models\\User', 43),
(73, 'App\\Models\\User', 67),
(74, 'App\\Models\\User', 43),
(74, 'App\\Models\\User', 67),
(75, 'App\\Models\\User', 43),
(75, 'App\\Models\\User', 67),
(76, 'App\\Models\\User', 43),
(76, 'App\\Models\\User', 67),
(77, 'App\\Models\\User', 43),
(77, 'App\\Models\\User', 67),
(78, 'App\\Models\\User', 43),
(78, 'App\\Models\\User', 67),
(79, 'App\\Models\\User', 43),
(79, 'App\\Models\\User', 67),
(80, 'App\\Models\\User', 43),
(80, 'App\\Models\\User', 67),
(81, 'App\\Models\\User', 43),
(81, 'App\\Models\\User', 67),
(82, 'App\\Models\\User', 43),
(82, 'App\\Models\\User', 67),
(83, 'App\\Models\\User', 43),
...
(97, 'App\\Models\\User', 43),
(98, 'App\\Models\\User', 43),
(99, 'App\\Models\\User', 43),
(100, 'App\\Models\\User', 43),
(101, 'App\\Models\\User', 43),
(102, 'App\\Models\\User', 43),
(103, 'App\\Models\\User', 43),
(104, 'App\\Models\\User', 43),
(104, 'App\\Models\\User', 44),
(104, 'App\\Models\\User', 71),
(104, 'App\\Models\\User', 73),
(105, 'App\\Models\\User', 43),
(105, 'App\\Models\\User', 67),
(106, 'App\\Models\\User', 43),
(106, 'App\\Models\\User', 67),
(107, 'App\\Models\\User', 43),
(107, 'App\\Models\\User', 44),
(107, 'App\\Models\\User', 67),
(107, 'App\\Models\\User', 71),
(107, 'App\\Models\\User', 73),
(108, 'App\\Models\\User', 43),
(108, 'App\\Models\\User', 67),
(109, 'App\\Models\\User', 43),
(109, 'App\\Models\\User', 67),
(110, 'App\\Models\\User', 43),
(110, 'App\\Models\\User', 67),
(111, 'App\\Models\\User', 43),
(111, 'App\\Models\\User', 67),
(112, 'App\\Models\\User', 43),
(112, 'App\\Models\\User', 67),
(113, 'App\\Models\\User', 43),
(114, 'App\\Models\\User', 43),
(115, 'App\\Models\\User', 43),
(116, 'App\\Models\\User', 43),
(117, 'App\\Models\\User', 43),
(118, 'App\\Models\\User', 43),
(120, 'App\\Models\\User', 47),
(120, 'App\\Models\\User', 49),
(120, 'App\\Models\\User', 50),
(120, 'App\\Models\\User', 52),
(120, 'App\\Models\\User', 54),
(120, 'App\\Models\\User', 68),
(120, 'App\\Models\\User', 69),
(120, 'App\\Models\\User', 70),
(121, 'App\\Models\\User', 47),
(121, 'App\\Models\\User', 49),
(121, 'App\\Models\\User', 50),
(121, 'App\\Models\\User', 52),
(121, 'App\\Models\\User', 54),
(121, 'App\\Models\\User', 68),
(121, 'App\\Models\\User', 69),
(121, 'App\\Models\\User', 70),
(122, 'App\\Models\\User', 47),
(122, 'App\\Models\\User', 49),
(122, 'App\\Models\\User', 50),
(122, 'App\\Models\\User', 52),
(122, 'App\\Models\\User', 54),
(122, 'App\\Models\\User', 68),
(122, 'App\\Models\\User', 69),
(122, 'App\\Models\\User', 70),
(123, 'App\\Models\\User', 44),
(123, 'App\\Models\\User', 71),
(123, 'App\\Models\\User', 73),
(124, 'App\\Models\\User', 44),
(124, 'App\\Models\\User', 71),
(124, 'App\\Models\\User', 73),
(125, 'App\\Models\\User', 44),
(125, 'App\\Models\\User', 71),
(125, 'App\\Models\\User', 73),
(132, 'App\\Models\\User', 43);
...
(11, 'Rafaela', 'Banjarnegara', '08123567211', 69, 'L', '20', '65', '165'),
(12, 'Ahmad Toni', 'Purwokerto', '081225144924', 70, 'L', '21', '60', '160');
...
(123, 'janji-konselings.janjikonselor', 'web', '2024-05-09 03:41:43', '2024-05-09 03:41:43'),
(124, 'janji-konselings.detailbykonselor', 'web', '2024-05-09 18:22:10', '2024-05-09 18:22:10'),
(125, 'konselings.konselingbykonselor', 'web', '2024-05-09 18:22:10', '2024-05-09 18:22:10'),
(126, 'generated::NTlMzGHSgjp3fTUo', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(127, 'generated::am7tJifCgXwx1XsR', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(128, 'generated::5FobQAC8fSLAU1aR', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(129, 'generated::WVO9f8nvDee6LMwS', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(130, 'generated::Z9xjbe46EWwkc9Jm', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(131, 'getAlamatPasien', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21'),
(132, 'konselings.rekapkonseling', 'web', '2024-05-26 11:33:21', '2024-05-26 11:33:21');
...
--
-- Table structure for table `table_email_create_token`
--

CREATE TABLE `table_email_create_token` (
...
--
-- Dumping data for table `table_email_create_token`
--

INSERT INTO `table_email_create_token` (`email`, `token`, `created_at`) VALUES
('yazid@gmail.com', 'ERIrC2jsSVwudGGWXPh9eRXjym6EamFiET8HNpvgKpPIpeiY3AMs3yEJEsyrBjcblqmmzsSPFvloecuS', '2024-05-19 07:47:58'),
('yazid@gmail.com', 'xjuFLuYpBN45qO4l6txY9c0artfda1zVg7aFORhIJ3tWoEPPLyWdXqf7oWoOvD2ks8NupPeuzc1lfdx4', '2024-05-19 07:57:31');
...
(42, 'Gilang Dely Mukti', 'gilang@gmail.com', '2024-05-09 04:16:25', '$2y$10$U5MhcWWbuNcLgQcfooAHfeF8UHuXXu.zkUoJjWiltdkgDjS8HZDgK', NULL, '2024-05-07 11:24:48', '2024-05-07 11:24:48', 'gilang', 0),
(43, 'Dwi Maryanti', 'dwimaryanti@gmail.com', '2024-04-14 08:11:13', '$2y$10$ylattCOBn4utdS6cqOf.y.NgY/tHp07RAB/RlphwE5bWhjLoN9c3O', NULL, '2024-05-07 11:25:10', '2024-05-07 11:25:10', 'dwimaryanti', 0),
(44, 'Ersa Mahera Rinatri', 'ersa@gmail.com', '2024-05-25 02:45:16', '$2y$10$rxNQqptPaU/8.uvYMmN1NOF.mqppyyc9ivW0tyA/0Gl2Rigk/y8YW', NULL, '2024-05-07 11:25:43', '2024-05-18 22:17:32', 'echamhr', 0),
(69, NULL, 'rafaela@gmail.com', '2024-05-20 02:09:08', '$2y$10$zSTLH6g617Vt1gG2DyrI.uvHyLetKlXrr6RnlMd5WAaFWy4I0S/rm', NULL, '2024-05-20 02:08:34', '2024-05-20 02:09:08', 'rafaela', 1),
(70, NULL, 'toni@gmail.com', '2024-05-20 02:27:44', '$2y$10$QnAVDsYnEkGKvMkHM/h2auSepjMGJV9htdfmtIWKGsS.Cudmjilwu', NULL, '2024-05-20 02:27:21', '2024-05-20 02:27:44', 'toni', 1),
(71, 'Anggreani', 'anggreani@gmail.com', '2024-05-25 02:50:47', '$2y$10$yVpeidi4O2wTJW/Az.lSsuEPkNQOR7dTTeFRVPK/wOzLsZ0rEZe0W', NULL, '2024-05-20 02:31:05', '2024-05-20 02:31:05', 'anggreani', 0),
(73, 'Yuliana Lestari', 'yuliana@gmail.com', NULL, '$2y$10$YH0xKyCe6pcW.9WYfApwU.7952TiQTfszlIbMIWywAjW8yqPvsHZK', NULL, '2024-05-26 09:55:14', '2024-05-26 09:55:14', 'yuliana', 0);
...
ALTER TABLE `konseling`
  ...
  ADD KEY `id_konselor` (`id_konselor`),
  ADD KEY `id_janjikonseling` (`id_janjikonseling`);
...
--
ALTER TABLE `konseling`
  MODIFY `id_konseling` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
